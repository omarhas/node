...
// Endpoint pour afficher un étudiant par son nom
app.get('/students/:nom', (req, res) => {
...
// Endpoint pour afficher la moyenne de tous les étudiants
app.get('/students/moyenne', (req, res) => {
...
return acc + student.modules.reduce((acc, module) => {
...
// Endpoint pour afficher la meilleure et la pire note de chaque étudiant
app.get('/students/best-worst', (req, res) => {
